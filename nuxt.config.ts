...
export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    "/consult": { ssr: false, prerender: true, headers: noIndexHeaders },
    "/flow": { ssr: false, prerender: true, headers: noIndexHeaders },
    "/annual-flow": { ssr: false, prerender: true, headers: noIndexHeaders },
  ...
  runtimeConfig: {
    ...
    public: {
      ...
      appVersion: process.env.NUXT_PUBLIC_APP_VERSION || "2.1.0",
