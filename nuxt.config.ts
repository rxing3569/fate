...
export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    "/chart": { ssr: false, prerender: false },
    "/flow": { ssr: false, prerender: false },
    "/issue-report": { ssr: false, prerender: false },
    "/match": { ssr: false, prerender: false },
    "/member": { ssr: false, prerender: false },
    "/nwp-live-check": {
      ssr: false,
      prerender: false,
      headers: {
    ...
    "/payment-result": { ssr: false, prerender: false },
    "/point-history": { ssr: false, prerender: false },
    "/profile/edit": { ssr: false, prerender: false },
    "/purchase-history": { ssr: false, prerender: false },
    "/qa": { ssr: false, prerender: false },
    "/report": { ssr: false, prerender: false },
  ...
  runtimeConfig: {
    ...
    public: {
      ...
      appVersion: process.env.NUXT_PUBLIC_APP_VERSION || "1.2.5",
